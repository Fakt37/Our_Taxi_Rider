...
import com.example.ourtaxirider.Model.Rate;
    ...
    private void submitRateDetails(final String driverId) {
        ...
        rateDetailRef.child(driverId)
                                        ...
                                        driverInformationRef.child(Common.driverId)
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        alertDialog.dismiss();
                                                        Toast.makeText(RateActivity.this, "Рейтинг обновлён, но не добавлен в БД", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                    }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        alertDialog.dismiss();
                        Toast.makeText(RateActivity.this, "Отзыв не отправлен", Toast.LENGTH_SHORT).show();
                    }
                });
