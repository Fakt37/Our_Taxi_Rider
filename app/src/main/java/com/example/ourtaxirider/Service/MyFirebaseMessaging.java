...
import com.example.ourtaxirider.Helper.NotificationHelper;
...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void showArrivedNotificationAPI26(String body) {
        ...
        Notification.Builder builder = notificationHelper.getOurTaxiNotification("Прибытие", body, contentIntent, defaultSound);
